...
text(t(3),max(x)-(max(x)-min(x))*.1,['Migration Rate =' num2str(slopemeters, 2) ' m/yr'], 'fontsize', 15);
text(t(3),max(x)-(max(x)-min(x))*.2,['Final Shore Position =' num2str(x(end), 3) ' km'], 'fontsize', 15);
